...
2.  **Configure as variáveis de ambiente:**
    Crie um arquivo `.env` na raiz do projeto com as credenciais do banco de dados e o segredo do JWT, conforme definido em `application-prod.properties` e `docker-compose.yaml`.
    ```env
    POSTGRES_DB=salesdb
    POSTGRES_USER=admin
...
3.  **Construa e suba os containers:**
    ...
    ```
    Este comando irá construir a imagem da aplicação, baixar a imagem do PostgreSQL e iniciar os dois containers. A API estará acessível em `http://localhost:8080`.
