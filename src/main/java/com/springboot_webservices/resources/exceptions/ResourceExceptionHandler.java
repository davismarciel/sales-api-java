package com.springboot_webservices.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> resourceNotFound(ResourceNotFoundException e, HttpServletRequest request) {
        ...
        StandardError err = new StandardError(Instant.now(), status, e.getMessage(), error, request.getRequestURI());
